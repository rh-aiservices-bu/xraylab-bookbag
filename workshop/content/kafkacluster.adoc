...
This is a very simple deployment, with no dedundancy to save on resources for this Lab. So don't do this at home (read production)! Don't use this config outside this Lab.
